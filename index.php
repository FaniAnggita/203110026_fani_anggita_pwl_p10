...
<body>
    ...
    <div class="container mt-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between px-md-1">
                            <div>
                                ...
                                ?>
                                <h3 class="text-danger"><?php echo $data['total']; ?></h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between px-md-1">
                            <div>
                                ...
                                $data = mysqli_fetch_assoc($result);
                                ?>
                                <h3 class="text-success"><?php echo $data['total']; ?></h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between px-md-1">
                            <div>
                                ...
                                $data = mysqli_fetch_assoc($result);
                                ?>
                                <h3 class="text-warning"><span>Rp </span><?php echo number_format($data['total']); ?></h3>
        ...
        <div class="row">
            ...
            <table id="tblUser" class="table table-hover table-striped table-bordered">
